<%@ Page Title="" Language="C#" MasterPageFile="~/BackAdmin/MasterBoard.Master" AutoEventWireup="true" CodeBehind="BookList.aspx.cs" Inherits="Project.BackAdmin.BookList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False">
        <Columns>
            ...
            <asp:BoundField DataField="Date" HeaderText="上架日期" />
            <asp:BoundField DataField="EndDate" HeaderText="下架日期" />

            <asp:TemplateField HeaderText="管理">
                <ItemTemplate>            <%--  <%# Eval("BookID") %>: 資料繫結運算式  --%>
